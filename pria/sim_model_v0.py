...
class Trainer():
  def __init__(self, data_folder, model_name="convnet_", epochs=100):
    ...
    # set trainnig to 90%
    self.split_index = self.total_images * 90 // 100 #int(self.even_total * 0.9)
...
if __name__=="__main__":
  ...
  if len(sys.argv) == 4:
    ...
    # Trainer(data_folder, model, epochs).infer(300)
# 
  else:
