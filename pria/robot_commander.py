...
class RobotCommander(Node):
    ...
    def rgb_listener_callback(self, msg):
        ...
        if self.state == 2 or (self.state == 1 and self.image_count == 0):
            # Get current transform for the image ground truth
            T, Q = self.lookup_transform_('initial_pose', 'wrist_3_link')
            ...
            print("Image ", self.image_count, "/", self.image_count_max, end='\r')
            self.image_count += 1
    ...
    def lookup_transform_(self, to_frame_rel, from_frame_rel):
        """
